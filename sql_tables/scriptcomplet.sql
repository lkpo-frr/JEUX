...
(6, 'Gameplay', 'Il est possible de courrir et de se déplacer dans 8 directions, les déplacements sont donc bien plus rapides', 1, 22),
...
(3, 'Censure', 'Les références à la religion ont été supprimées', 0, 2),
